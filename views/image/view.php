...
[
    ...
    'value' => ($model->getPhotoGallery()->one() ? Html::a($model->getPhotoGallery()->one()->name, ['image-gallery/view', 'id' => $model->getPhotoGallery()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
[
    'format' => 'html',
    'label'=>'Image',
